...
https://www.cancer.org/cancer/breast-cancer/about/types-of-breast-cancer/triple-negative.html
	These tumor islands express significant heterogeneity reflecting various genetic variations that likely explain their variable clinical response/outcome.  This project will utilize TCGA high throughput genomic data to investigate 123 BRCA female patients diagnosed with triple negative breast cancer between the ages of 26 and 90.  Similarily, I will analyze 401 BRCA female patients diagnosed with ER+ PR+ HER2-non-amplified (via FISH) diagnosed between the ages of 26 and 90, too.  I will be controlling for race and ethnicity.  
