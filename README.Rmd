...
![](UpdatedFinalProject_files/figure-html/unnamed-chunk-28-1.png)<!-- -->
...
![](UpdatedFinalProject_files/figure-html/unnamed-chunk-39-1.png)<!-- -->

```r
plotMA(resNorm, xlim=xlim, ylim=ylim, main="normal")
```

![](UpdatedFinalProject_files/figure-html/unnamed-chunk-39-2.png)<!-- -->

```r
plotMA(resAsh, xlim=xlim, ylim=ylim, main="ashr")
```

![](UpdatedFinalProject_files/figure-html/unnamed-chunk-39-3.png)<!-- -->
...
![](UpdatedFinalProject_files/figure-html/unnamed-chunk-63-1.png)<!-- -->
